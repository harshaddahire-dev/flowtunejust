...
export const Logo: React.FC<IconProps> = (props) => (
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <g filter="url(#glow)">
      <circle cx="50" cy="50" r="45" fill="none" stroke="url(#logo-gradient)" strokeWidth="8"/>
      <path d="M 50 15 V 50 H 75" fill="none" stroke="url(#logo-gradient)" strokeWidth="8" strokeLinecap="round"/>
      <path d="M 60 75 V 40 C 60 25 80 25 80 40 S 60 55 60 70" fill="none" stroke="url(#logo-gradient)" strokeWidth="8" strokeLinecap="round"/>
      <circle cx="53" cy="75" r="8" fill="url(#logo-gradient)"/>
    </g>
  </svg>
);
